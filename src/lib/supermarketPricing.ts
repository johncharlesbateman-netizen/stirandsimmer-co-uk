export type SupermarketId = "tesco" | "sainsburys" | "asda" | "ocado" | "waitrose" | "morrisons";
...
export function estimateAllPrices(
  ...
  const supermarkets: SupermarketId[] = ["tesco", "sainsburys", "asda", "ocado", "waitrose", "morrisons"];
