  ...
  return (
    <Layout>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Browse ${total ? `over ${total} ` : ""}tried-and-tested recipes for UK home cooks — weeknight dinners to weekend cooking, in grams, Celsius and supermarket ingredients.`}
        />
        ...
        <meta property="og:description" content={`Browse ${total ? `over ${total} ` : ""}tried-and-tested recipes for UK home cooks — weeknight dinners to weekend cooking, in grams, Celsius and supermarket ingredients.`} />
        ...
        <meta name="twitter:description" content={`Browse ${total ? `over ${total} ` : ""}tried-and-tested recipes for UK home cooks — weeknight dinners to weekend cooking, in grams, Celsius and supermarket ingredients.`} />
